        ...
        function (err, rows, fields) {
            if (!err) {
                if (rows != '') {
                    ...
                    res.write('<tr><th style="width:33%">Team</th><th style="width:33%">Captain</th><th style="width:33%">Email/ Phone</th></tr>');
                    for (i = 0; i < rows.length; i++) {
                        res.write('<tr><td style="vertical-align:middle" class="w3-small w3-hide-medium w3-hide-large">' + rows[i].clubName + ' ' + rows[i].teamName + '</td><td style="vertical-align:middle" class="w3-hide-small">' + rows[i].clubName + ' ' + rows[i].teamName + '</td><td style="vertical-align:middle" class="w3-small w3-hide-medium w3-hide-large">' + rows[i].firstName + ' ' + rows[i].lastName + '</td><td style="vertical-align:middle" class="w3-hide-small" >' + rows[i].firstName + ' ' + rows[i].lastName + '</td><td style="vertical-align:middle" class="w3-small w3-hide-medium w3-hide-large"><a href="mailto:' + rows[i].email + '">' + rows[i].email + '</a><br><a href="tel:' + rows[i].phone + '">' + rows[i].phone + '</a></td><td style="vertical-align:middle" class="w3-hide-small"><a href="mailto:' + rows[i].email + '">' + rows[i].email + '</a><br><a href="tel:' + rows[i].phone + '">' + rows[i].phone + '</a></td></tr>');
                    }
